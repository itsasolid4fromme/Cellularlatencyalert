# Defines target IP address and email settings
$targetIP = "8.8.8.8"
$emailTo = "To Email"
    ...
    if ($pingResult -ne $DebugPreference) {
        ...
        if ($responseTime -ge 250) {
            ...
            if ($consecutiveHighResponseTimes -ge 5) {
                $message = "Ping to $targetIP exceeded 250ms for 5 consecutive replies, fix your shit. Response time: ${responseTime}ms"
